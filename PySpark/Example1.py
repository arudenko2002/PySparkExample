...
if __name__ == '__main__':
    ...
    RDDread = sc.textFile ("C:\Users\Alexey\workspace\PySpark\PySpark\CHANGES.txt")
    ...
    sc = SparkContext(conf=conf)
    Country = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\Country.txt")
    CountryLanguage = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\CountryLanguage.txt")
    ...
    sc = SparkContext(conf=conf)
    confusedRDD = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\confused.txt")
    ...
    sc = SparkContext(conf=conf) 
    partRDD = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\CHANGES.txt",4)
    print "KKKKKKK ", partRDD.getNumPartitions()
    userRDD = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\user.txt")
    ...
    sc = SparkContext(conf=conf)
    userRDD = sc.textFile("C:\Users\Alexey\workspace\PySpark\PySpark\user.txt").cache()
